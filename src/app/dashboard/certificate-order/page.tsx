...
import { ArrowLeft, ArrowRight, CheckCircle, Award, Loader2, Home, Truck, Copy } from 'lucide-react';
...
export default function CertificateOrderPage() {
  ...
  return (
    <div className="p-4 md:p-8 flex justify-center items-start min-h-screen bg-muted/40">
