...
export default function POSPage() {
    ...
    const handleAddToCart = (item: PrescriptionDrug | GeneralStoreItem) => {
        ...
        const newItem: CartItem = {
            ...item,
            price: item.price,
            quantity: isPrescription ? item.correctAnswers.quantity : 1,
                                        ...
                                        filteredStoreItems.map(item => {
                                            ...
                                            return (
                                                 <div key={item.id} className={cn("flex items-center justify-between p-3 border rounded-md", isAdded ? "bg-muted/30" : "bg-muted/80")}>
                                                    ...
                                                    <Button size="sm" onClick={() => handleAddToCart(item)} disabled={isPaid || isAdded}>
