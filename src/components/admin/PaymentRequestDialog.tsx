...
function UserDetailsSection({ request }: { request: PaymentRequest }) {
    ...
    const isTempUser = 'first_name' in userData && 'last_name' in userData;
    ...
    return (
        <div className="space-y-3 rounded-md border p-4 bg-muted/50">
            ...
            <div className="text-sm space-y-2 text-muted-foreground">
                {isFullUser && <p className="flex items-center gap-2"><UserIcon className="h-4 w-4 text-primary shrink-0" /><strong className="text-card-foreground">{userData.full_name}</strong></p>}
                {isTempUser && <p className="flex items-center gap-2"><UserIcon className="h-4 w-4 text-primary shrink-0" /><strong className="text-card-foreground">{`${userData.first_name} ${userData.last_name}`}</strong></p>}

                {isFullUser && <p className="flex items-center gap-2"><Mail className="h-4 w-4 text-primary shrink-0" /><span className="truncate">{userData.e_mail}</span></p>}
                {isTempUser && <p className="flex items-center gap-2"><Mail className="h-4 w-4 text-primary shrink-0" /><span className="truncate">{userData.email_address}</span></p>}

                {isFullUser && userData.telephone_1 && (
                 ...
                 {isFullUser && userData.telephone_2 && userData.telephone_1 !== userData.telephone_2 && (
                    <div className="flex items-center gap-2">
                        <Phone className="h-4 w-4 text-primary shrink-0" />
                ...
                {isTempUser && userData.phone_number && (
                     <div className="flex items-center gap-2">
                        <Phone className="h-4 w-4 text-primary shrink-0" />
                 ...
                 {isTempUser && userData.whatsapp_number && userData.phone_number !== userData.whatsapp_number && (
                     <div className="flex items-center gap-2">
                        <Phone className="h-4 w-4 text-primary shrink-0" />
